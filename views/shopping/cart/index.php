...
<div class="container py-3">
	...
	<div class="col-lg-12">
		<button id="process-orders-button" class="btn btn-block btn-outline-success col-lg-4 ml-auto" onclick="placeOrders(this);">Place Orders</button>
	</div>
	<div id="cart-container" class="row justify-content-around py-3">
	</div>
	<h3><i>Shop More?</i></h3>
