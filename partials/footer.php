<!-- Start Footer -->
	    ...
	    <div><small class="text-mute">All data inside this project are generated only from mockaroo.com "This project is for educational purposes only"</small></div>
	  </footer>
		<!-- End Footer -->
	</main>
	<!-- End Main -->
  ...
  <script>
	...
	<!-- end firebase -->
	<?php endif; ?>
	<script type="module" src="<?php get_url() ?>/assets/js/script.js"></script>
	<!-- custome page js -->
	<?php global $page_js; ?>
